 ...
 *
 * This file includes the referenced bin path (../laminas-api-tools/api-tools-oauth2/bin/bcrypt.php) using ob_start to remove the shebang if present
...
$binPath = __DIR__ . "/" . '../laminas-api-tools/api-tools-oauth2/bin/bcrypt.php';
